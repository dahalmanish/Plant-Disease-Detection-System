...
const Home = () => {
  ...
  return (
    ...
    <div className='flex justify-end w- w-11/12 h-96 bg-no-repeat bg-top gap-0'>
      <div><h1 className='absolute font-serif text-white text-6xl left-28 top-28 '>Healthy Plants,<br/> Happy Gardens</h1></div>
      ...
      <div className='absolute right-72 top-36'> 
        <img src='Images/arrow.png' alt='arrow' className='w-40'/></div>
    ...
    <div className='flex justify-center w-full h-52 bg-transparent'>
      <div className='bg-white h-full w-4/6 my-5  rounded-full flex justify-center drop-shadow '>
